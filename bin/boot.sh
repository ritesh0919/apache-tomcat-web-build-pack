...
exec JAVA_HOME=$APP_ROOT/public/java/jdk1.8.0_25 JAVA_OPTS=\"-Djava.io.tmpdir=$TMPDIR
 -XX:OnOutOfMemoryError=$APP_ROOT/public/java/jdk1.8.0_25/bin/killjava.sh -Xmx382293K
